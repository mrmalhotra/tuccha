...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_link_service__ = __webpack_require__("../../../../../src/app/services/link.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__services_link_service__["a" /* LinkService */]],
...
module.exports = "<div class=\"row\" style=\"margin-top:100px\">\r\n <div class=\"col-sm-2\"></div>\r\n  <div class=\"col-sm-8\">\r\n<div class=\"container\">\r\n  <form class=\"form-group\" (submit)=\"getMeUrl()\">\r\n    <label>Enter your link here</label>\r\n    <input class=\"form-control\" type=\"text\" name=\"url\" [(ngModel)]=\"url\">\r\n    <input class=\"btn btn-primary\" type=\"submit\" value=\"Go\">\r\n  </form>\r\n</div>\r\n</div>\r\n</div>\r\n\r\n<div class=\"jumbotron\">\r\n <div class=\"row\">\r\n   <div class=\"col-sm-2\"></div>\r\n   <div *ngIf=\"shortenUrl.length >=1\" class=\"col-sm-8\">\r\n     {{baseUrl}}{{shortenUrl}}\r\n   </div>\r\n </div>\r\n</div>\r\n<!--*ngFor=\"let shortUrls of urlArray; let index = i;\"-->\r\n<div style=\"padding-left: 10px; padding-right: 10px\">\r\n  <table class=\"table table-hover\">\r\n    <thead>\r\n    <tr>\r\n      <th scope=\"col\">Original Url</th>\r\n      <th scope=\"col\">Short Url</th>\r\n    </tr>\r\n    </thead>\r\n    <tbody>\r\n    <tr class=\"table-default\" *ngFor=\"let listOfUrl of urlArray\">\r\n      <td>{{listOfUrl.url}}</td>\r\n      <td>{{baseUrl}}{{listOfUrl.shortenUrl}}</td>\r\n    </tr>\r\n    </tbody>\r\n  </table>\r\n</div>\r\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    function HomeComponent(http, linkService) {
        this.http = http;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        if (!localStorage.getItem('sessionId')) {
            this.linkService.getSessionId().subscribe(function (session) {
    ...
    HomeComponent.prototype.getMeUrl = function () {
        var _this = this;
        console.log('url is ', this.url);
        if (this.url != undefined) {
            console.log('is not undefined');
            this.linkService.getShortUrl(this.url, this.sessionId).subscribe(function (shortUrl) {
                console.log('value while sub ', shortUrl);
                if (shortUrl.success) {
                    console.log('got the shortUrl', shortUrl);
                    _this.shortenUrl = shortUrl.url.shortenUrl;
                }
                else {
                    _this.shortenUrl = '';
                }
    ...
    HomeComponent.prototype.getSessions = function () {
        var _this = this;
        console.log("i am in getSession call");
        this.linkService.getAllUrls(this.sessionId).subscribe(function (urls) {
            console.log('got all urls ', urls.shortUrl[0]);
            for (var a = 0; a < urls.shortUrl.length; a++) {
                // console.log('check value 'urls.shortUrl[a].shortenUrl)
                _this.urlArray[a] = urls.shortUrl[a];
            }
            console.log('chekc the array ', _this.urlArray);
        }, function (error) {
            console.log('got some error in getting url ', error);
        });
    };
    HomeComponent.prototype.getEnv = function () {
        var _this = this;
        this.linkService.getEnvVariable().subscribe(function (env) {
            console.log('got env', env);
            _this.baseUrl = env.result;
        }, function (error) {
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */],
            __WEBPACK_IMPORTED_MODULE_3__services_link_service__["a" /* LinkService */]])
    ], HomeComponent);
...
var LinkService = /** @class */ (function () {
    ...
    LinkService.prototype.getShortUrl = function (url, sessionId) {
    ...
    LinkService.prototype.getSessionId = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('/link/getSessionId', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    LinkService.prototype.getEnvVariable = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('/link/rest/getenv', { headers: headers })
            .map(function (res) { return res.json(); });
    };
    LinkService.prototype.getAllUrls = function (currentSessionId) {
